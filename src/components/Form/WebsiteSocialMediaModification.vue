 <template>
   <div>
      <p class="caption">Website/Social Media Modification Type<font color="red">*</font></p>
      <div class="row q-pa-sm">
         <div class="col-3">
            <q-radio v-model="job_order.service_requested_details.website_modification_type" val="Intranet Update"  label="Intranet Update" />
         </div>
         <div class="col-3">
            <q-radio v-model="job_order.service_requested_details.website_modification_type" val="Social Media Update" label="Social Media Update" />
         </div>
         <div class="col-3">
            <q-radio v-model="job_order.service_requested_details.website_modification_type" val="Website Update" label="Website Update" />
         </div>
          <div class="col-3">
            <q-radio v-model="job_order.service_requested_details.website_modification_type" val="Others" label="Others" />
         </div>
      </div>
      <br>
        ...
        return {
            job_order: {
                ...
                service_request_details: {
                    ...
                    service_requested_type: "Website/Social Media Modification",
                    supervisor_noted_by: '',
                    date_noted: ''
                },
        ...
        submitform() {
            ...
            if (this.$v.job_order.service_requested_details.$error) {
                ...
                swal({
                    ...
                    .then((toSubmit) => {
                        if (toSubmit) {
                            this.job_order.job_order_no = String(+new Date().getFullYear()).substring(4, 2) + "-2-" + "00".substring(0, "00".length - ((this.$dbCon.services.joborders.data.length + 1) + "").length) + (this.$dbCon.services.joborders.data.length + 1);
