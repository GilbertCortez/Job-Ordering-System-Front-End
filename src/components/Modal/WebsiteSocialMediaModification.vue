      ...
      <q-modal  v-model="opened" maximized  no-backdrop-dismiss no-esc-dismiss >
         ...
         <div class="q-pa-md row">
            <div class="col-8">
               ...
               <div class="col-6">
                     <span class="q-caption">Website/Social Media Modification Type</span>
                        <div class="row q-pa-sm q-body-1">
                        <q-radio v-model="job_order.service_requested_details.website_modification_type" class="col-6"  val="Intranet Update"  label="Intranet Update" readonly />
                        <q-radio v-model="job_order.service_requested_details.website_modification_type" class="col-6" val="Social Media Update" label="Social Media Update" readonly />
                        <q-radio v-model="job_order.service_requested_details.website_modification_type" class="col-6"  val="Website Update" label="Website Update" readonly/>
                        <q-radio v-model="job_order.service_requested_details.website_modification_type"  class="col-6" val="Others" label="Others" readonly />
                     </div>
                  </div>
                  <div class="col-6">
   ...
   components: {
    ...
    updated() {
      this.validateMISStaff() 
        ...
        this.job_order.service_requested_details.website_modification_type = JSON.parse(this.jod).service_requested_details.website_modification_type
